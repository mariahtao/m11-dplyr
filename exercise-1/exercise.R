...
vehicles.2wheeldrive <- vehicles[vehicles$drive == '2-Wheel Drive' & vehicles$cty > 20, ]

# Of those vehicles, what is the vehicle ID of the vehicle with the worst hwy mpg?
worst.hwy <- vehicles.2wheeldrive$id[vehicles.2wheeldrive$hwy == min(vehicles.2wheeldrive$hwy)]
